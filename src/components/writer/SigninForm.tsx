...
export default function SigninForm() {
    ...
    const { isLoading, isError, errorMessage, writerSignin } = writerAuthStore()
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (typeof email === "string" && typeof password === "string") {
                await writerSignin(email, password)
                if (writerAuthStore.getState().isSignedIn) {
    ...
    return (
        <div className="mt-48 border border-blue-500 rounded-md max-w-3xl py-20 px-28 shadow-xl">
            <div className="text-center mb-8 p-0">
                ...
                <h2 className="text-xl font-semibold text-blue-500">Signin</h2>
            </div>
            <Form
            ...
            >
                ...
                <div>
                    {
                        isLoading ? (<Button isDisabled className="w-32"><Spinner /></Button>) : (<Button color="primary" type="submit" className="w-32 font-semibold">
                            Signin
                        </Button>)
                    }
                </div>
                ...
                <div>
                    New? <Link href={"/writer/signup"} className="text-blue-500">Signup</Link>
                </div>
